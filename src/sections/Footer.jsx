...
const Footer = () => {
  return (
    <footer className="max-container">
      <div className="flex justify-bewteen items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          <a href="/">
            <img src={footerLogo} width={156} height={46} />
          </a>
      ...
      <div className="flex justify-bewteen text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
